...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post commands_url, params: { command: { amount: @command.amount, date: @command.date, paid: @command.paid, table_id: @command.table_id, user_id: @command.user_id } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { amount: @command.amount, date: @command.date, paid: @command.paid, table_id: @command.table_id, user_id: @command.user_id } }
